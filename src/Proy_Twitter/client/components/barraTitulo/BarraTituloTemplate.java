...
public class BarraTituloTemplate extends JPanel {
    ...
    public void crearJButons() {
     ...
     public void crearJLabels() {
        ...
        iDimaux = new ImageIcon(iPerfil.getImage().getScaledInstance(50, 50, Image.SCALE_AREA_AVERAGING));
